...
$("<div>",{"id":"boxiviewer"}).appendTo(this.container);

$("<div>",{"class":"iviewer_zoom_in iviewer_common iviewer_button"}).bind("mousedown touchstart",function(){me.zoom_by(1);return false}).appendTo('#boxiviewer');

$("<div>",{"class":"iviewer_zoom_out iviewer_common iviewer_button"}).bind("mousedown touchstart",function(){me.zoom_by(-1);return false}).appendTo('#boxiviewer');
...
$("<div>",{"class":"iviewer_left iviewer_common iviewer_button"}).bind("mousedown touchstart",function(){var x = $('#img-20').iviewer('info','coords'); var largura =	$('#img-20').width(); me.moveTo(largura*0.2,240);return false}).appendTo('#boxiviewer');


$("<div>",{"class":"iviewer_up iviewer_common iviewer_button"}).bind("mousedown touchstart",function(){var largura =	$('#img-20').width();me.moveTo(largura/2,100);return false}).appendTo('#boxiviewer');
$("<div>",{"class":"iviewer_zoom_fit iviewer_common iviewer_button"}).bind("mousedown touchstart",function(){me.fit(this);return false}).appendTo('#boxiviewer');

$("<div>",{"class":"iviewer_down iviewer_common iviewer_button"}).bind("mousedown touchstart",function(){var largura =	$('#img-20').width(); var altura =	$('#img-20').height();  me.moveTo(largura/2,altura-100);return false}).appendTo('#boxiviewer');

$("<div>",{"class":"iviewer_right iviewer_common iviewer_button"}).bind("mousedown touchstart",function(){var zoom = $('#img-20').iviewer('info','zoom'); var largura =	$('#img-20').width(); me.moveTo(largura*0.8,240);return false}).appendTo('#boxiviewer');





this.update_status()}});$.ui.iviewer.ImageObject=function(do_anim){this._img=$("<img>").css({position:"absolute",top:"0px",left:"0px"});this._loaded=false;this._swapDimensions=false;this._do_anim=do_anim||false;this.x(0,true);this.y(0,true);this.angle(0)};(function(){this._reset=function(w,h){this._angle=0;this._swapDimensions=false;this.x(0);this.y(0);this.orig_width(w);this.orig_height(h);this.display_width(w);this.display_height(h)};
